...
private:
	...
	struct Cost
	{
		...
		Cost(int distanceFromStart, int distanceTillEnd, Vector2<int> cameFrom);
...
private:
	...
	std::function<int(Vector2i, Vector2i)> mDistanceAlgorithm;
